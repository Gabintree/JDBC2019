...
%>
<h3>[<%=id %>]님 환영합니다.<br>
	로그인 아이디 기억상태를 [<%= (rememberId.equals("temp")?"유지하지않음":"유지함") %>]으로 설정하셨습니다.</h3>
	<form action ="20190524_CookieSessionLogout.jsp" method="post">
...
%>
 <h3>로그인 하지 않으셨거나, 잘못된 접근입니다.<br>
 	로그인하여 주시기 바랍니다. </h3>
	<form action = "20190524_CookieSessionLogin.jsp"  method ="post">
